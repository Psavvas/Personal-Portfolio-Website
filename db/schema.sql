...
-- ============================================================
-- Admin portal authentication (Better Auth)
--
-- These four tables are generated by Better Auth and store the
-- owner account, its password hash, and active login sessions.
-- Column names are quoted camelCase because that is what Better
-- Auth queries — do not rename them.
-- ============================================================
